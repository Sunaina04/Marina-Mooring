      ...
      <div className="flex justify-between p-4 ml-8">
        ...
        <div className="flex flex-col ">
          <div className="w-[43vw] h-14 mt-11">
            ...
            <div className="-translate-y-[45vh] translate-x-[5vw]">{/* <Timeline /> */}</div>
            <div className="-translate-y-[45vh] translate-x-[20vw]">{/* <Timeline /> */}</div>
          ...
          <div className="bg-[#F2F2F2] rounded-xl border-[1px] border-[#D1D1D1] p- mt-[25rem] w-[43vw] ">
            <DataTableComponent
              header={Boatsheader}
              tableStyle={{
                fontSize: '0.90rem',
