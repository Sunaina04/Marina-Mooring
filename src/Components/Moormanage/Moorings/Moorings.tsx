...
const Moorings = () => {
        ...
        <div className="flex items-center ">
          <div className="p-input-icon-left">
            ...
            <InputText
              ...
              className="h-[5vh] w-[40vh] cursor-pointer text-[0.55rem]
  ...
  <div className="flex ml-12 gap-4 ">
    {/* Left Panel */}
    <div className="bg-[F2F2F2] overflow-x-hidden overflow-y-scroll rounded-md border-[1px] w-[25vw] bag-[#D1D1D1] h-96 border-gray-300 ">
      <div className="text-sm font-extrabold rounded-sm w-full  bg-[#D9D9D9]">
        <h1 className="p-4">Moorings</h1>
      </div>
      <DataTableSearchFieldComponent
      ...
      <div className="absolute top-72">
        ...
        <div className="rounded-md border-[1px] pb-1 border-gray-300 mt-16 ml-10 w-[17vw]  h-[13vh] bg-white">
          ...
          <div className="flex">
            ...
            <div>
              <p className="text-[0.6rem] text-black mt-1">Need inspection</p>
              <p className="text-[0.6rem] text-black tracking-tighter mt-[0.3rem]">Gear On (in the water)</p>
            </div>
            {/* Additional Status Circles */}
            <div className="ml-1">
              <FaCircle className="h-3 text-violet-600 mt-1 " data-testid="Facircle3" />
              <FaCircle className="h-3 text-gray-500 mt-2" data-testid="Facircle4" />
            </div>
            ...
            <div>
              <p className="text-[0.6rem] text-black tracking-tighter mt-1">Gear Off (out of the water)</p>
              <p className="text-[0.6rem] text-black mt-[0.3rem]">Not in Use</p>
            </div>
          </div>
        </div>
