export const properties = {
  ...
  boatyardMooringHeader: 'Marina Moorings',
  serviceAreaMooringHeader: 'Service Area Moorings',
  boatyardDetail: 'Marinas Detail',
  serviceAreaDetail: 'Service Area Detail',
  address: 'Address',
  mooringInventoried: 'Mooring Inventoried',
  boatyardGPSCoordinates: 'Marina GPS Coordinates',
  serviceAreaGPSCoordinates: 'Marina GPS Coordinates',
