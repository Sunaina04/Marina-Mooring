...
// import { properties } from '../../Utils/MeassageProperties';
// import { WorkOrderValue } from '../../../Type/ComponentBasedType';
// import { pdfMake, vfsFonts } from 'pdfmake/build/pdfmake';
...
//   const dataToPdf = (data: WorkOrderPayload[]) => {
...
//     pdfMake.createPdf(docDefinition).download('WorkOrders.pdf');
//   };
...
//           <div className="flex justify-end gap-6 mt-6 mr-16">
//             <Button
//               onClick={() => dataToPdf(workOrderData)}
//               style={{
//                 width: '125px',
//                 height: '44px',
//                 minHeight: '44px',
...
//           className="bg-[F2F2F2]  ml-12  mt-3 mr-14">
//           <div className="flex flex-wrap align-items-center justify-between  bg-[#00426F] p-2 rounded-tl-[10px] rounded-tr-[10px]">
//             <h1 className="p-2 text-xl font-extrabold text-white">
//               Work Orders
//             </h1>
